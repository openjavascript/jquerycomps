;(function(define, _win) { 'use strict'; define( 'Bizs.ExampleComponent', [ 'JC.BaseMVC' ], function(){
/**
 * 组件用途简述
 *
 *  <p><b>require</b>:
 ...
 *      | <a href='http://jc2.openjavascript.org/docs_api/classes/Bizs.ExampleComponent.html' target='_blank'>API docs</a>
 *      | <a href='../../modules/Bizs.ExampleComponent/0.1/_demo' target='_blank'>demo link</a></p>
 *  
 *  <h2>页面只要引用本脚本, 默认会自动处理 div class="js_bizExampleComponent" </h2>
 *
 ...
 * @example
        <h2>Bizs.ExampleComponent 示例</h2>
 */
    var _jdoc = $( document ), _jwin = $( window );

    Bizs.ExampleComponent = ExampleComponent;
    ...
    ExampleComponent.init =
        function( _selector ){
            ...
            if( _selector.length ){
                if( _selector.hasClass( 'js_bizExampleComponent' )  ){
                    _r.push( new ExampleComponent( _selector ) );
                }else{
                    _selector.find( 'div.js_bizExampleComponent' ).each( function(){
    ...
    ExampleComponent.Model._instanceName = 'BizExampleComponent';
    ...
    _jdoc.ready( function(){
        ...
        }, null, 'ExampleComponentasdfaserf', 1 );
    });

    return Bizs.ExampleComponent;
