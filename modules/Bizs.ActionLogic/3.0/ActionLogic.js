 ...
 * | <a href='../../modules/Bizs.ActionLogic/3.0/_demo' target='_blank'>demo link</a></p>
 *
 ...
 */
    ...
    JC.PureMVC.build( ActionLogic, JC.SelectorMVC );
    ...
    JC.f.extendObject( ActionLogic.prototype, {
        _beforeInit:
            function(){
    ...
    JC.f.extendObject( ActionLogic.Model.prototype, {
        init:
            function(){
            }
    ...
    JC.f.extendObject( ActionLogic.View.prototype, {
        init:
            function(){
            }
    });
