 ;(function(define, _win) { 'use strict'; define( 'JC.FlowChart0.2', [ 'JC.BaseMVC', 'jsPlumb&Toolkit' ], function(){
    ...
    FlowChart.getInstance = function ( _selector, _setter ) {
        if( typeof _selector == 'string' && !/</.test( _selector ) ) 
            _selector = $(_selector);
        if( !(_selector && _selector.length ) || ( typeof _selector == 'string' ) ) return;
        typeof _setter != 'undefined' && _selector.data( FlowChart.Model._instanceName, _setter );

        return _selector.data( FlowChart.Model._instanceName );
    };
     ...
     */
    FlowChart.init = function( _selector ){
        var _r = [];
    ...
    FlowChart.exportData = function( _selector ) {
        var _ins = FlowChart.getInstance( _selector );
            !_ins && ( _ins = new FlowChart( _selector ) );
