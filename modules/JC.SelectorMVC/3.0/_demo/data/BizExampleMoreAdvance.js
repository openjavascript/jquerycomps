 ...
 */
    ...
    function BizExampleMoreAdvance( _selector ){
        ...
        if( JC.SelectorMVC.getInstance( _selector, BizExampleMoreAdvance ) ) 
            return JC.SelectorMVC.getInstance( _selector, BizExampleMoreAdvance );

        JC.SelectorMVC.getInstance( _selector, BizExampleMoreAdvance, this );
