 ...
 */
    ...
    function CompExampleMoreAdvance( _selector ){
        ...
        if( JC.SelectorMVC.getInstance( _selector, CompExampleMoreAdvance ) ) 
            return JC.SelectorMVC.getInstance( _selector, CompExampleMoreAdvance );

        JC.SelectorMVC.getInstance( _selector, CompExampleMoreAdvance, this );
