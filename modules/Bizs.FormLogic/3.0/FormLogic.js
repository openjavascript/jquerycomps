...
<pre>function formResetCallback( _evt, _ins ){
    ...
    */
    ...
    function FormLogic( _selector ){
        ...
        if( JC.SelectorMVC.getInstance( _selector, FormLogic ) ) 
            return JC.SelectorMVC.getInstance( _selector, FormLogic );

        JC.SelectorMVC.getInstance( _selector, FormLogic, this );
    ...
    JC.PureMVC.build( FormLogic, JC.SelectorMVC ); 
    /**
     * 获取或设置 FormLogic 的实例
     * @method getInstance
    ...
    FormLogic.getInstance =
        function( _selector, _setter ){
            return JC.SelectorMVC.getInstance( _selector, FormLogic, _setter );
        };
