 ...
 */
    ...
    JC.PureMVC.build( Placeholder, JC.SelectorMVC );
    /**
    ...
    JC.f.extendObject( Placeholder.prototype, {
        _beforeInit:
            function(){
    ...
    JC.f.extendObject( Placeholder.Model.prototype, {
        init:
            function(){
    ...
    JC.f.extendObject( Placeholder.View.prototype, {
        init:
            function(){
