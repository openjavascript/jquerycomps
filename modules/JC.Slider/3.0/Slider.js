;(function(define, _win) { 'use strict'; define( [ 'JC.SelectorMVC' ], function(){
    ...
    function Slider( _layout ){
         ...
         * 初始化数据模型
         */
        this._model = new Slider.Model( _layout );
        this._model._layout = _layout;
        /**
         * 初始化视图模型( 根据不同的滚动方向, 初始化不同的视图类 )
         */
        switch( this._model.direction() ){
            case 'vertical': this._view = new Slider.VerticalView( this._model, this ); break;
            default: this._view = new Slider.HorizontalView( this._model, this ); break;
        }

        this._init();
    }

    JC.PureMVC.build( Slider, JC.SelectorMVC );
    
    JC.f.extendObject( Slider.prototype, {
        /**
         * 内部初始化方法
    ...
    JC.f.extendObject( Slider.Model.prototype, {
        init:
            function(){

                this._layout = $( this._selector );
    ...
    Slider.HorizontalView =
        function( _model, _slider ){
            this._model = _model;
    ...
    JC.f.extendObject( Slider.HorizontalView.prototype, {
        init:
            function() {
    ...
    JC.f.extendObject( Slider.VerticalView.prototype, {
        init:
            function() {
                this.setPagePosition( this._model.pointer() );
                return this;
