...
<dl class="def example{$count}">
    ...
    <dd>
    <input type='checkbox' id='checkall{$count}_1' value='' name='' checked checkall="#checkall{$count}" inverse="#checkall{$count}_inverse" />
    <label for='checkall{$count}_1'>checkall{$count}_1</label>
    <input type='checkbox' id='checkall{$count}_2' value='' name='' checked checkall="#checkall{$count}" inverse="#checkall{$count}_inverse"  />
    <label for='checkall{$count}_2'>checkall{$count}_2</label>
    <input type='checkbox' id='checkall{$count}_3' value='' name='' checked checkall="#checkall{$count}" inverse="#checkall{$count}_inverse"  />
    <label for='checkall{$count}_3'>checkall{$count}_3</label>
    <input type='checkbox' id='checkall{$count}_4' value='' name='' checked checkall="#checkall{$count}" inverse="#checkall{$count}_inverse"  />
    <label for='checkall{$count}_4'>checkall{$count}_4</label>
    <input type='checkbox' id='checkall{$count}_5' value='' name='' checked checkall="#checkall{$count}" inverse="#checkall{$count}_inverse"  />
